...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame.setStyleSheet("background-color: #0a0a0a;")
        ...
        self.label.setText("")
        self.gif=QMovie("D:\Chest_x_ray_Detection-master\ezgif.com-speed.gif")
...
"}")
    ...
    def upload_image(self):
        ...
        global result
        result=classes
        speak("Status: Image loaded. Prediction can now be made.")
